    ...
    df = pd.concat([
      ...
      pd.DataFrame(
        ...
        index=[0])
                   ...
                   ignore_index=True)
  for feat in features_code:
      df = df.drop(df[(df["ICD Sub-Chapter Code"] == feat)].index,
                 axis=0)
  return df

#### Engineer Other Data
df = combine_data(df,["W00-X59","Y85-Y89"],"W00-X59,Y85-Y89",'Unintentional Deaths besides Motor Vehicles')
...
df = combine_data(df,["D00-D09","D10-D36","D37-D48"],"D00-D48",'Benign neoplasm')

df = combine_data(df,["O00-O07","O10-O16","O20-O29","O30-O48","O60-O75","O85-O92","O95-O99"],"O00-O99",'Complicated Pregnancy')

df = combine_data(df,["Q00-Q07","Q20-Q28","Q30-Q34","Q38-Q45",
"Q60-Q64","Q65-Q79","Q80-Q89","Q90-Q99"],"Q00-Q99",'Congenital Anomalies')


df = combine_data(df,["I00-I02","I05-I09","I10-I15","I20-I25","I26-I28","I30-I51"],"I00-I51",'Heart Disease')

print(df[df['ICD Sub-Chapter Code']=='I00-I51']["Deaths"])

df = combine_data(df,["N00-N07","N10-N15","N17-N19","N25-N28"],"N00-I28",'Nephritis')

df = combine_data(df,["E40-E46","E50-E64"],"E40-E64",'Nutritional Deficiency')

df = combine_data(df,["P00-P04","P10-P15","P20-P29","P35-P39","P50-61","P90-P96"],"P00-P96",'Perinatal Period')
...
all_ages = ["1-4","5-14","15-24","25-34","35-44","45-54","55-64","65-74","75-84","85+"]
...
ax = sns.heatmap(values, annot=texts, fmt="",cbar=False)
